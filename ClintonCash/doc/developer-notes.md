...
ClintonCash is a multithreaded application, and deadlocks or other multithreading bugs
...
However, in open source software such as ClintonCash, where everyone uses
...
pay attention to for reviewers of ClintonCash code.
...
- For `strprintf`, `LogPrint`, `LogPrintf` formatting characters don't need size specifiers
  ...
  - *Rationale*: ClintonCash uses tinyformat, which is type safe. Leave them out to avoid confusion
