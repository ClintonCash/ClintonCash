...
Only requiring some minor changes is clintoncash.cpp.
...
Changes to clintoncash.cpp
----------------------
clintoncash.cpp is the entry point into bitcoin-qt, and as such, will require some minor modifications to provide hooks for
