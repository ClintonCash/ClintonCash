    ...
    platformStyle(platformStyle)
{
    ...
    QString windowTitle = tr("ClintonCash") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a ClintonCash address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and clintoncash: URIs)"));
    ...
    aboutAction = new QAction(QIcon(":/icons/" + theme + "/about"), tr("&About ClintonCash"), this);
    aboutAction->setStatusTip(tr("Show information about ClintonCash"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for ClintonCash"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your ClintonCash addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/" + theme + "/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified ClintonCash addresses"));
    ...
    openAction->setStatusTip(tr("Open a clintoncash: URI or payment request"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the ClintonCash help message to get a list with possible ClintonCash command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle *networkStyle)
{
    ...
    QString toolTip = tr("ClintonCash client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::updateNetworkState()
{
    ...
    if (clientModel->getNetworkActive()) {
        labelConnectionsIcon->setToolTip(tr("%n active connection(s) to ClintonCash network", "", count));
    } else {
...
{
    QString strTitle = tr("ClintonCash"); // default title
