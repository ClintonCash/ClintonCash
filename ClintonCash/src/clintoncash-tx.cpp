...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || mapArgs.count("-?") || mapArgs.count("-h") || mapArgs.count("-help"))
    {
        ...
        std::string strUsage = _("ClintonCash clintoncash-tx utility version") + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  clintoncash-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded clintoncash transaction") + "\n" +
              "  clintoncash-tx [options] -create [commands]   " + _("Create hex-encoded clintoncash transaction") + "\n" +
              "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded clintoncash transaction
