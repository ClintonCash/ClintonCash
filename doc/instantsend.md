...
This mechanism has been integrated into Bitcore-Node-ClintonCash which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/clintoncashpay/insight-api-clintoncash#web-socket-api](https://github.com/clintoncashpay/insight-api-clintoncash#web-socket-api)
* API: [https://github.com/clintoncashpay/insight-api-clintoncash#instantsend-transactions](https://github.com/clintoncashpay/insight-api-clintoncash#instantsend-transactions)
...
By default, the ClintonCash daemon will launch using the following constant:

```
static const int DEFAULT_INSTANTSEND_DEPTH = 5;
```

This value can be overridden by passing the following argument to the ClintonCash daemon:
