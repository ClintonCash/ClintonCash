    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    QString version = tr("ClintonCash") + " " + tr("version") + " " + QString::fromStdString(FormatFullVersion());
    ...
    if (helpMode == about)
    {
        setWindowTitle(tr("About ClintonCash"));
        ...
        QString header = tr("Usage:") + "\n" +
            "  clintoncash-qt [" + tr("command-line options") + "]                     " + "\n";
...
All the ClintonCash in your wallet is comprised of different \"inputs\" which you can think of as separate, discrete coins.<br> \
...
These denominations are 0.01 CCASH, 0.1 CCASH, 1 CCASH and 10 CCASH -- sort of like the paper money you use every day.</li> \
    ...
    QWidget(parent, f)
{
    ...
    layout->addWidget(new QLabel(
        tr("ClintonCash is shutting down...") + "<br /><br />" +
