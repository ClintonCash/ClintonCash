...
#define BOOST_TEST_MODULE ClintonCash Test Suite

#include "test_clintoncash.h"
...
#endif
        ClearDatadirCache();
        pathTemp = GetTempPath() / strprintf("test_clintoncash_%lu_%i", (unsigned long)GetTime(), (int)(GetRand(100000)));
